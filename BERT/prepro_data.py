...
def prepro_data_train(train_file_list):
    ...
    for line in train_file_list:
        ...
        train_label_example.append(line[8].strip('\n'))
    ...
    return train_arg_1, train_arg_2, train_label_list, train_label_conn, train_conn, train_label_example
...
def prepro_data_dev(dev_file_list):
    ...
    for line in dev_file_list:
        ...
        dev_label_example.append(line[9].strip('\n'))
    ...
    return dev_arg_1, dev_arg_2, dev_label_list, dev_conn_1, dev_label_example
...
def prepro_data_test(test_file_list):
    ...
    for line in test_file_list:
        ...
        test_label_example.append(line[9].strip('\n'))
    ...
    return test_arg_1, test_arg_2, test_label_list, test_conn_1, test_label_example
